...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(L1Deposit::ToTwineAddress).string().not_null())
                ...
                .col(ColumnDef::new(L1Deposit::CreatedAt).timestamp_with_time_zone().not_null())
                .primary_key(Index::create().col(L1Deposit::Nonce).col(L1Deposit::ChainId))
                .to_owned()
        ).await?;
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(L1Withdraw::ChainId).big_unsigned().not_null())
                ...
                .col(ColumnDef::new(L1Withdraw::ToTwineAddress).string().not_null())
                ...
                .col(ColumnDef::new(L1Deposit::CreatedAt).timestamp_with_time_zone().not_null())
                .primary_key(Index::create().col(L1Withdraw::Nonce).col(L1Withdraw::ChainId))
                .to_owned()
        ).await?;
        ...
        manager.create_table(
            Table::create()
                ...
                .if_not_exists()
                .col(ColumnDef::new(L2Withdraw::ChainId).big_unsigned().not_null())
                ...
                .col(ColumnDef::new(L2Withdraw::ToTwineAddress).string().not_null())
                ...
                .col(ColumnDef::new(L1Deposit::CreatedAt).timestamp_with_time_zone().not_null())
                .primary_key(Index::create().col(L2Withdraw::Nonce).col(L2Withdraw::ChainId))
                .to_owned()
        ).await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.drop_table(Table::drop().table(L1Deposit::Table).to_owned()).await?;
        manager.drop_table(Table::drop().table(L1Withdraw::Table).to_owned()).await?;
        manager.drop_table(Table::drop().table(L2Withdraw::Table).to_owned()).await?;
        Ok(())
    }
}
